...
Open the deployed private route from a room-authenticated browser session. The client connects to `./.well-known/meshagent/room/connect` and exposes chat, meeting, and file views for that room.
